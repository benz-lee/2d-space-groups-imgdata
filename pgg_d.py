    ...
    for _ in range(k):
        ...
        for n in range(0, width, w):
            for m in range(0, height, h):
                ...
                dot1 = [(w/2-x - radius+n, h/2-y - radius+m), (w/2-x + radius+n, h/2-y + radius+m)]
                dot2 = [(w/2+x - radius+n, h-y - radius+m), (w/2+x + radius+n, h-y + radius+m)]
                dot3 = [(w-x - radius+n, h/2+y - radius+m), (w-x + radius+n, h/2+y + radius+m)]
